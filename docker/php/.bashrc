...
export PS1="$(get_user)${CYAN_BOLD}@$(get_host) ${WHITE}(env:${RESET} ${GREEN}$(get_env)${WHITE})${RESET} $(get_working_directory) ${YELLOW_BOLD}\$(get_branch)${GREEN_BOLD}\$(get_tag) ${BLACK_BOLD}\n\$${RESET} "
